  ...
  screeningForms.forEach(function (form) {
    form.addEventListener("submit", function (event) {
      ...
      if (currentLanguage === "en") {
        confirmationNotice = "Thank you for reaching out to Velora Formazione! We have recorded your application and Country of Origin details. Our study orientation advisors will contact you shortly at phone +3533183329 or via email.";
      } else {
  ...
  function enforceGlobalConsistency(lang) {
    ...
    if (!document.getElementById("velora-floating-action-bar")) {
      ...
      floatBar.innerHTML = `
        ...
        <a href="tel:+3533183329" class="floating-action-btn floating-btn-phone" aria-label="Call Velora Desk">
        ...
        <a href="https://wa.me/3533183329" target="_blank" rel="noopener noreferrer" class="floating-action-btn floating-btn-whatsapp" aria-label="WhatsApp Support">
